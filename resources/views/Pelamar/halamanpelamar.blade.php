                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        <div class="collapse navbar-collapse justify-content-center" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" id="topnav-apps" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i data-feather="layers"></i> Lamaran <div></div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link arrow-none" href="#" id="topnav-components" role="button" aria-haspopup="true" aria-expanded="false">
